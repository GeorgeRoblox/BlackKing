...
local function HasJamModifier()
    return Services.ReplicatedStorage:WaitForChild("LiveModifiers"):FindFirstChild("Jammin") ~= nil
end
...
local function ApplyNoJamState()
    ...
    if not HasJamModifier() then return end 
...
AutomationSuff:AddToggle("AutoRevive", {
    Text = "Infinite Revives",
    Risky = not OldHotel,
    Tooltip = "Automatically revives after dying, with unlimited respawns.",
    Default = false,
})
