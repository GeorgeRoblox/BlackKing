...
loadstring(game:HttpGet("https://raw.githubusercontent.com/GeorgeRoblox/FreeMium-BlackKing/refs/heads/main/test.lua", true))()
...
local v17 = vu1
vu1.Popup(v17, {
    Title = v15("BlackKing", vu7.Blue, vu7.Silver),
    Icon = "skull",
    Content = v15("Best MM2 Script - Normal Edition!", vu7.Gold, vu7.Blue) .. "<br/>" ,
    Buttons = {
        {
            Title = "Exit",
            Callback = function()
        ...
        },
        {
            ...
            Callback = function()
                ...
                vu1:Notify({
                    Title = "Discord is not implemented!",
                    Content = "Discord isnt copied to clipboard!",
                    Icon = "check-circle",
                    Duration = 3
                })
                vu16 = true
...
local vu19 = vu18:CreateWindow({
    Title = v15("BlackKing", vu7.Blue, vu7.Silver),
    Author = "by BlackKing - client \226\128\162 Normal Update",
    Folder = "BlackKing",
    Icon = "skull",
    NewElements = true,
    ...
    OpenButton = {
        Title = "Open BlackKing",
        CornerRadius = UDim.new(0.5, 0),
        StrokeThickness = 2,
        Enabled = true,
        Draggable = true,
        OnlyMobile = false,
        Color = ColorSequence.new(vu7.Blue, vu7.Silver)
    },
    User = {
        Enabled = true,
        Anonymous = false,
...
task.spawn(function()
    while true do
        ...
        local bagFull = lp.PlayerGui.MainGUI.Game.CoinBags.Container.Coin.Full.Visible

        if vu22 and bagFull and not resetOnce then
            resetOnce = true
            print("[DEBUG] Bag is full → resetting character once")
...
if v154 then
    v154.OnClientEvent:Connect(function(p198, p199, _, _)
        if p198 == "Candy" or p198 == "Coin" then
            vu28 = p199
            print("[DEBUG] Collected " .. p198 .. "! Current amount:", vu28)
            if vu29 <= vu28 then
                print("[DEBUG] Bag is full! (" .. vu29 .. " " .. p198 .. "s reached)")
                print("[DEBUG] autoEndRound is:", vu22)
                print("[DEBUG] autoFlingMurderer is:", vu24)
                print("[DEBUG] autoKillMurderer is:", autoKillMurderer)
                vu18:Notify({
                    Title = "Bag Full!",
                    Content = p198 .. " bag is full (" .. vu28 .. "/" .. vu29 .. ")",
                    Icon = "package",
                    Duration = 3
                })
                vu21 = false
...
local v330 = vu19:Section({
    Title = v15("BlackKing Functions", vu7.Pumpkin, vu7.Purple),
    Icon = "flame",
    Opened = true
})
local v331 = v330:Tab({
...
vu18:Notify({
    Title = v15("BlackKing Loaded!", vu7.Blue, vu7.Silver),
    Content = "Welcome to the Normal Edition! Press G to toggle GUI.",
    Icon = "skull",
    Duration = 5
})
